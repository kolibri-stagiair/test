...
import { c as connectLabel, d as disconnectLabel } from './label-fd307fdd.js';
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-ca1c0889.js';
import { f as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-14b6fa72.js';
...
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-7c2a4548.js';
import './dom-656a3e0e.js';
...
async function getNormalizer(mode) {
    ...
    const { normalize } = await import('./time-zones-ba8074e2.js');
    return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index-3bccad5b.js');
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
            import('./index-986e43ee.js'),
            import('./region-d38b7927.js'),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        import('./index-4311bccf.js'),
        import('./index-c8e3fab8.js'),
    ]);
