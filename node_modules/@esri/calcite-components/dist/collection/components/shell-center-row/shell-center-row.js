...
export class ShellCenterRow {
    ...
    render() {
        const { el } = this;
        const contentNode = (h("div", { key: 'c89fa132b6cd339f0d9ec6168d474fafaf56a050', class: CSS.content }, h("slot", { key: 'ba5308ca473ce534897688c6e6f534bea54fde37' })));
        ...
        return h(Fragment, { key: '530d485879dc51cc95ab7ebb03fa2368b31e0101' }, children);
    }
