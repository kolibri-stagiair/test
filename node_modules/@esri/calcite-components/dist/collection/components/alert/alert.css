...
*/
:host {
  --calcite-internal-alert-edge-distance: 2rem;
  display: block;
...
.container {
  ...
  box-shadow: var(--calcite-alert-shadow, var(--tw-ring-offset-shadow, 0 0 rgba(0, 0, 0, 0)), var(--tw-ring-shadow, 0 0 rgba(0, 0, 0, 0)), var(--tw-shadow));
