...
const label = require('./label-baa45f8c.js');
...
const form = require('./form-a0aa32d4.js');
require('./dom-20c48ef3.js');
require('./guid-88d8b131.js');
require('./resources-dd12972d.js');
require('./component-37e59b5c.js');
require('./key-f102c715.js');
require('./observers-f1a1157c.js');
...
async function getNormalizer(mode) {
    ...
    const { normalize } = await Promise.resolve().then(function () { return require('./time-zones-5a9a6d84.js'); });
    return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await Promise.resolve().then(function () { return require('./index-e410cc8a.js'); });
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
            Promise.resolve().then(function () { return require('./index-d548d762.js'); }),
            Promise.resolve().then(function () { return require('./region-f0f57f4a.js'); }),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        Promise.resolve().then(function () { return require('./index-1c27c95a.js'); }),
        Promise.resolve().then(function () { return require('./index-b7f42ce9.js'); }),
    ]);
