...
const floatingUi = require('./floating-ui-1aa40113.js');
const guid = require('./guid-88d8b131.js');
const interactive = require('./interactive-e0d0d313.js');
const key = require('./key-f102c715.js');
const loadable = require('./loadable-228291fd.js');
const observers = require('./observers-f1a1157c.js');
const openCloseComponent = require('./openCloseComponent-e0342247.js');
const component = require('./component-37e59b5c.js');
...
const DropdownItem = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '1ec1c941651dda8f39fa15427592141f04180f3e', class: CSS.iconStart, flipRtl: iconFlipRtl === "start" || iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const contentNode = (index.h("span", { key: '3ab167ed4054ca34b4e13e72b752af6cf25522ae', class: CSS.itemContent }, index.h("slot", { key: '88cf44809fb48450c66cc8f105bbda008a78157d' })));
        const iconEndEl = (index.h("calcite-icon", { key: '32fb27182943a032c0037f1f878a95c194d2dff1', class: CSS.iconEnd, flipRtl: iconFlipRtl === "end" || iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
